        ...
        <div className="w-84 border border-gray-300 rounded-xl">
            ...
            <div className="p-4">
                ...
                <div className="pt-4 flex gap-2 flex-wrap">
                    <button className="text-sm text-gray-900 bg-gray-200 px-4 py-1.5 rounded-2xl">React</button>
                    <button className="text-sm text-gray-900 bg-gray-200 px-4 py-1.5 rounded-2xl">Node.js</button>
                    <button className="text-sm text-gray-900 bg-gray-200 px-4 py-1.5 rounded-2xl">Express.js</button>
                </div>
